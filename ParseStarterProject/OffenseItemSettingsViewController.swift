...
class OffenseItemSettingsViewController: UIViewController, UITextViewDelegate, UITextFieldDelegate {
    ...
    //hide disabled items
        ...
        if itemsDisabledOffense[8] == true {
            ...
            self.item9ButtonLabel.setImage(UIImage(named:"heal.png"), forState: UIControlState.Normal)
        }
        ...
        if itemsDisabledOffense[9] == true {
            ...
            self.item10ButtonLabel.setImage(UIImage(named:"superheal.png"), forState: UIControlState.Normal)
        }
        ...
        if itemsDisabledOffense[10] == true {
            ...
            self.item11ButtonLabel.setImage(UIImage(named:"shield.png"), forState: UIControlState.Normal)
        }
        ...
        if itemsDisabledOffense[11] == true {
            ...
            self.item12ButtonLabel.setImage(UIImage(named:"ghost.png"), forState: UIControlState.Normal)
        }
    ...
    @IBAction func saveButton(sender: AnyObject) {
        ...
        itemsDisabledOffense = [self.item1Disabled1, self.item2Disabled1, self.item3Disabled1, self.item4Disabled1, self.item5Disabled1, self.item6Disabled1, self.item7Disabled1, self.item8Disabled1, self.item9Disabled1, self.item10Disabled1, self.item11Disabled1, self.item12Disabled1]
        
        self.performSegueWithIdentifier("showItemOptionsViewControllerFromOffenseItemSettingsViewController", sender: nil)
        }
    }
    ...
    @IBAction func item3HelpButotn(sender: AnyObject) {
