...
class DefenseItemShopViewController: UIViewController, UITextViewDelegate, UITextFieldDelegate {
    ...
    @IBAction func item9Button(sender: AnyObject) {
        if slot1Powerup != 0 && slot2Powerup != 0 && slot3Powerup != 0 {
            ...
            if slot1Powerup == 0 {
                slot1Powerup = 13
                powerup1Slot.setImage(UIImage(named:"reach.png"), forState: UIControlState.Normal)
            }
            else if slot2Powerup == 0 {
                slot2Powerup = 13
                powerup2Slot.setImage(UIImage(named:"reach.png"), forState: UIControlState.Normal)
            }
            else if slot3Powerup == 0 {
                slot3Powerup = 13
                powerup3Slot.setImage(UIImage(named:"reach.png"), forState: UIControlState.Normal)
            }
    ...
    @IBAction func item10Button(sender: AnyObject) {
        if slot1Powerup != 0 && slot2Powerup != 0 && slot3Powerup != 0 {
            ...
            if slot1Powerup == 0 {
                slot1Powerup = 14
                powerup1Slot.setImage(UIImage(named:"fist.png"), forState: UIControlState.Normal)
            }
            else if slot2Powerup == 0 {
                slot2Powerup = 14
                powerup2Slot.setImage(UIImage(named:"fist.png"), forState: UIControlState.Normal)
            }
            else if slot3Powerup == 0 {
                slot3Powerup = 14
                powerup3Slot.setImage(UIImage(named:"fist.png"), forState: UIControlState.Normal)
            }
    ...
    @IBAction func item11Button(sender: AnyObject) {
        if slot1Powerup != 0 && slot2Powerup != 0 && slot3Powerup != 0 {
            ...
            if slot1Powerup == 0 {
                slot1Powerup = 15
                powerup1Slot.setImage(UIImage(named:"sickle.png"), forState: UIControlState.Normal)
            }
            else if slot2Powerup == 0 {
                slot2Powerup = 15
                powerup2Slot.setImage(UIImage(named:"sickle.png"), forState: UIControlState.Normal)
            }
            else if slot3Powerup == 0 {
                slot3Powerup = 15
                powerup3Slot.setImage(UIImage(named:"sickle.png"), forState: UIControlState.Normal)
            }
    ...
    @IBAction func item12Button(sender: AnyObject) {
        if slot1Powerup != 0 && slot2Powerup != 0 && slot3Powerup != 0 {
            ...
            if slot1Powerup == 0 {
                slot1Powerup = 16
                powerup1Slot.setImage(UIImage(named:"lightning.png"), forState: UIControlState.Normal)
            }
            else if slot2Powerup == 0 {
                slot2Powerup = 16
                powerup2Slot.setImage(UIImage(named:"lightning.png"), forState: UIControlState.Normal)
            }
            else if slot3Powerup == 0 {
                slot3Powerup = 16
                powerup3Slot.setImage(UIImage(named:"lightning.png"), forState: UIControlState.Normal)
            }
